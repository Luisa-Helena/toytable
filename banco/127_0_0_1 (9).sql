...
--
-- Host: 127.0.0.1
-- Tempo de geração: 11-Out-2023 às 04:44
...
CREATE TABLE `tb_cadastro` (
  ...
  `senha_usuario` char(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tb_cadastro` (`id_usuario`, `nome_usuario`, `email_usuario`, `telefone_usuario`, `senha_usuario`) VALUES
(1, 'Zinatto', 'zina@gmail.com', '17992345653', '12');
...
('root', '2023-10-11 02:32:03', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
